...
var cardDeck = [
  ...
  "<div class='5'><h2>Anti-Fashion Ninties</h2> <p>The early 1990s embodied relaxed fit jeans, plain T-shirts & knit sweaters. Comfort became the emphasis for Americans during the decade, rejecting the uncomfortable clothing trends of the previous decade. By 1992, grunge music reached high popularity, bringing with it a new fashion trend that would define the decade. Plaid flannel shirts, stonewashed jeans, & dark colors like maroon, gray, forest green, and brown dominated the decade.</p></div>",
  ...
  "<div class='7'><h2>1961-1980: Body Art</h2> <p>Body art diffused the veil between artist and artwork by placing the body front & center as actor, medium, performance, and canvas. In the post-1960s atmosphere of changing social mores & thawed attitudes toward nudity, the body became a tool to make the political personal. Using the body became a way for an artist to connect the individual with the universal human experience- one person asking others to resonate as a whole.</p></div>",
  ...
  "<div class='8'><h2>1958-Early 1970s: Happenings</h2> <p>Happenings involved the viewer. Each instance a Happening occurred the viewer was used to add in an element of chance so, every time a piece was performed or exhibited it would never be the same as the previous time. Unlike preceding works of art which were static, Happenings could evolve & provide a unique encounter for each who partook in the experience; they were temporal & fleeting. The only artifacts remaining from original Happenings are photographs & oral histories.</p></div>",
  ...
  "<div class='9'><h2>1870-1915: Tonalism</h2> <p>\"Tonalism\" describes a style of American art focused primarily on depicting landscape, emphasizing tonal values to express mood or poetic feeling. Its origins date back to the early 1870s, when James McNeill Whistler, began using musical terms to title his work. At this time, he started looking at paintings as if they were musical compositions, arranging tonal values and colors as a composer would score a series of related notes.</p></div>",

  "<div class='10'><img src='./resources/images/10.jpg'> <p class='credit'>Prince, Richard. <em class='italic'>Untitled (Cowboy).</em> 1989.</p></div>",

  "<div class='10'><h2>1974-1984: The Pictures Generation</h2> <p>Influenced by the use of advertising and the highly saturated image culture of the United States, Pictures Generation artists produced work that itself resembles advertising. Challenging traditional art forms that appear handcrafted & singular, these artists situated themselves at the center of postmodern debates about authenticity & authorship while in the process creating art that was glossy, carry the appearance of mass production. Their works blur the lines between high art & popular imagery.</p></div>",

  "<div class='11'><img src='./resources/images/11.jpg'> <p class='credit'>Judd, Donald. <em class='italic'>Untitled.</em> 1969.</p></div>",

  "<div class='11'><h2>1960s-Late 1960s: Minimalism</h2> <p>Minimalism emerged in New York in the early 1960s; from artists renouncing the current 'stale and academic' scene. Minimalism favored the cool over the \"dramatic\"; using industrial materials & emphasized anonymity over the expressive excess of Abstract Expressionism. Painters & sculptors avoided overt symbolism & emotional content, but instead called attention to the materiality of the works.</p></div>",
